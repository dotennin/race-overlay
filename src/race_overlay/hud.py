...
def render_hud_frame(
    ...
    _draw_route_map(draw, route_points, layout.map_box)
    return image


def _draw_route_map(draw: ImageDraw.ImageDraw, route_points: list[tuple[float, float]], map_box: tuple[int, int, int, int]) -> None:
